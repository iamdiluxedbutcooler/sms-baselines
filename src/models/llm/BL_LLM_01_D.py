...
def run_bl_llm_01_D(train_texts: List[str], train_labels: List[str], 
    ...
    try:
        ...
        print("Few-shot GPT-4o completed successfully")
        
    except Exception as e:
        print(f"Few-shot GPT-4o failed: {e}")
        results["error"] = str(e)
    ...
    summary_path = os.path.join("experiments", config.get("baseline_id") or "bl_llm_01_D", "summary.csv")
