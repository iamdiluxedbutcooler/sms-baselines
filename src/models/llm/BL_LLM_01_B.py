...
def run_bl_llm_01_B(train_texts: List[str], train_labels: List[str], 
    ...
    meta = {
        ...
        "paper_title": "Few-shot Mixtral 8x7B",
        "paper_year": 2025,
        "method": "few_shot",
        "num_examples": 5
    }
    ...
    try:
        ...
        print("Running few-shot inference on test set...")
        predictions = []
        ...
        print("Few-shot Mixtral completed successfully")
        
        del model
        torch.cuda.empty_cache()
        
    except Exception as e:
        print(f"Few-shot Mixtral failed: {e}")
        results["error"] = str(e)
    ...
    summary_path = os.path.join("experiments", config.get("baseline_id") or "bl_llm_01_B", "summary.csv")
